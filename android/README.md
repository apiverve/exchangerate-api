...
```gradle
dependencies {
    implementation 'com.github.apiverve:exchangerate-api:1.1.14'
}
```
...
```java
import com.apiverve.exchangerate.ExchangeRateAPIClient;
import com.apiverve.exchangerate.APIResponse;
import com.apiverve.exchangerate.APIException;

// Initialize the client
ExchangeRateAPIClient client = new ExchangeRateAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("currency1", "USD");
    parameters.put("currency2", "EUR");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/exchangerate](https://docs.apiverve.com/ref/exchangerate)
...
- **Documentation:** [https://docs.apiverve.com/ref/exchangerate](https://docs.apiverve.com/ref/exchangerate)
- **Issues:** [GitHub Issues](https://github.com/apiverve/exchangerate-api/issues)
