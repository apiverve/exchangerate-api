...
namespace APIVerve\Exchangerate;
 ...
 * ```
 *
 * @see https://exchangerate.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/exchangerate';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ExchangerateClient] {$message}\n";
        }
    }
}
