...
const (
	baseURL        = "https://api.apiverve.com/v1/exchangerate"
	defaultTimeout = 30 * time.Second
)

// Client is the Exchange Rate API client.
type Client struct {
	apiKey     string
...
// Execute makes a request to the Exchange Rate API with typed parameters.
//
