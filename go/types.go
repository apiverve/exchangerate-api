// Package exchangerate provides a Go client for the Exchange Rate API.
//
// For more information, visit: https://exchangerate.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Exchange Rate API.
//
// Parameters:
//   - currency1 (required): string - The first currency you want to get the exchange rate for
//   - currency2 (required): string - The second currency you want to get the exchange rate for
type Request struct {
	Currency1 string `json:"currency1"` // Required
	Currency2 string `json:"currency2"` // Required
}
...
// ResponseData contains the data returned by the Exchange Rate API.
