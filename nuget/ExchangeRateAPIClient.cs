...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/exchangerate";
        ...
        {
            { "currency1", new ValidationRule { Type = "string", Required = true } },
            { "currency2", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ExchangeRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ExchangeRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ExchangeRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ExchangeRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(ExchangeRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ExchangeRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ExchangeRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ExchangeRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ExchangeRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ExchangeRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ExchangeRateQueryOptions options)
        {
